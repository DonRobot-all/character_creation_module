"""
Trainer / Simulator in which you choose a hero. 
You could attack and block random damage.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """To generate random damage for player."""
...
def start_training(char_name: str, char_class: str) -> str:
    """Сharacter description. Action choice."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Character selection and role in the game."""
